          ...
          <div className="row">
            <div className="col-lg-3 pt-30">
              ...
              <div className="hero-content wow fadeInUp delay-0-2s">
                <div className="clienti-reviews">
                  ...
                  <div className="reviews">50+ Global Brands <span>(4.98 of 5)</span>
                    <p>Trusted by athletic, trail, and luxury footwear brands.</p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="hero-image">
                <img src="assets/images/about/hero-sole.jpg" alt="YOUR SOLE Engineering" />
              </div>

            </div>
            <div className="col-lg-3 pt-30">
              <div className="hero-content wow fadeInUp delay-0-4s">
                <p>Engineered for stride. Obsessed with detail. High-precision outsoles, dual-density midsoles, and carbon propulsion plates.</p>
